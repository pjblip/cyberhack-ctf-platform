...
export const MOCK_CASES: Challenge[] = [
  ...
  // ==============================================================================
  // TIER 3: BLACK OPS (HARD) - 1 Challenge, 250 Points Each, Total 250
  // ==============================================================================
  {
    id: 'crypto004',
    title: 'Ransomware Reversal',
    description: 'A ransomware infected our server. We recovered the encryption script and the encrypted flag. Reverse the math to recover the data.',
    difficulty: 'hard',
    points: 250,
    hint: 'The script uses XOR encryption with key 0x42. XORing the encrypted hex with 0x42 again will reveal the plaintext.',
